        ...
        btnShareLink.setOnClickListener((view) -> {
            shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
                ...
                public void onSuccess(Sharer.Result result) {
                    Toast.makeText(SharePage.this, "share successful", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onCancel() {
                    Toast.makeText(SharePage.this, "Share cancel", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onError(FacebookException error) {
                    Toast.makeText(SharePage.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
